...
export function ResourceCard({ resource, index, namespaceFallback }: ResourceCardProps) {
...
const parseResourceKey = (resourceKey: string, namespaceFallback?: string): ResourceIdentifier => {
